...
import styles from './AverageForm.module.css';
...
export class AverageForm extends React.Component {
    state: IState;
    ...
    handleCalculateAverage = () => {
        axios({
            ...
            axios({
                ...
                data: {Numbers: [response.data, this.state.numbers.length]}
    ...
    render() {
        return (
            <div className={styles.outer}>
                ...
                <Button color="primary" onClick={this.handleCalculateAverage}>
                    Calculate Average
                </Button>
            </div>
        )
